...
Set-AWSCredentials -AccessKey AKIAJAIXHCRXVHOORN5A -SecretKey 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
...
foreach ($computer in $computers) {
    ...
    #$dat
    Write-CWMetricData -Namespace "Windows Server Custom Matrix" -MetricData $dat -Region ap-south-1
}
